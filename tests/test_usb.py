...
class TestStick:
    ...
    async def test_sed_node(self, monkeypatch: pytest.MonkeyPatch) -> None:  # noqa:  PLR0915
        ...
        assert test_sed.battery_config.dirty
        mock_stick_controller.append_response(sed_config_accepted)
    ...
    async def test_scan_node(self, monkeypatch: pytest.MonkeyPatch) -> None:  # noqa: PLR0915
        ...
        assert not test_scan.battery_config.dirty
        ...
        mock_stick_controller.append_response(scan_config_accepted)
    ...
    async def test_sense_node(self, monkeypatch: pytest.MonkeyPatch) -> None:  # noqa: PLR0915
        ...
        def fake_cache(dummy: object, setting: str) -> str | None:  # noqa: PLR0911 PLR0912
            ...
            if setting == pw_sense.CACHE_SENSE_HYSTERESIS_TEMPERATURE_LOWER_BOUND:
                return "25.0"
            if setting == pw_sense.CACHE_SENSE_HYSTERESIS_REPORT_INTERVAL:
                return "15"
            return None
    ...
    async def test_node_discovery_and_load(  # noqa: PLR0915
        ...
        get_state_timestamp = dt.now(UTC).replace(minute=0, second=0, microsecond=0)
        assert stick.nodes["1111111111111111"].is_loaded
